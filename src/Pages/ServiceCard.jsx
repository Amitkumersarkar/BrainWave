...
const ServiceCard = ({ service, idx }) => {
    ...
    return (
        <div className="relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-2xl shadow-gray-100 dark:shadow-white/10">
            ...
            <div className="pointer-events-none blur-2xl rounded-full bg-gradient-to-r transition-opacity duration-500 mix-blend-lighten opacity-70" style={{ top: position.y - 150, left: position.x - 150 }}>
